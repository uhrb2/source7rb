...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/redaiq90/k_jj_j"
    )
    ...
    PMPERMIT_TEXT_k_jj_j = os.environ.get("PMPERMIT_TEXT_k_jj_j", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in k_jj_j
