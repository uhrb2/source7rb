...
#جميع الحقوق محفوظة لسـورس 7rB  تخـمط تبيـن فشلـك
...
async def tmgif(event):
    if event.fwd_from:
        return
    F_O_1 = await reply_id(event)
    if sad:
        l313l = f"**˛ JEP ، ٰ𝖦𝗂𝖿 𝖲ِ𝖺ٰ𝖣 . .**\n"
        l313l += f"✛━━━━━━━━━━━━━✛\n"
        l313l += f"**الـمتحـرڪـة الأولـى **"
        await event.client.send_file(event.chat_id, sad, caption=l313l, reply_to=F_O_1)
