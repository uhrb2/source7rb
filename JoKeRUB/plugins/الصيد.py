...
hrrrbType_cmd = (
    "𓆩 أنواع اليوزرات 𓆪\n\n"
    "### ✾╎ قائمة أنواع اليوزرات التي يمكن صيدها مع الأمثلة:\n"
    "- **`.صيد ثلاثي1`**  (مثال: A_D_R)\n"
    "- **`.صيد ثلاثي2`**  (مثال: A_7_R)\n"
    "- **`.صيد ثلاثي3`**  (مثال: A_7_0)\n\n"
    "- **`.صيد رباعي1`**  (مثال: AAA_R)\n"
    "- **`.صيد رباعي2`**  (مثال: A_RRR)\n"
    "- **`.صيد رباعي3`**  (مثال: AA_RR)\n"
    "- **`.صيد رباعي4`**  (مثال: AA_AR)\n"
    "- **`.صيد رباعي5`**  (مثال: AA_RA)\n"
    "- **`.صيد رباعي6`**  (مثال: AR_RA)\n"
    "- **`.صيد رباعي7`**  (مثال: AR_AR)\n"
    "- **`.صيد رباعي8`**  (مثال: AR_RR)\n\n"
    "- **`.صيد شبه رباعي1`**  (مثال: A_A_A_R)\n"
    "- **`.صيد شبه رباعي2`**  (مثال: A_R_R_R)\n"
    "- **`.صيد شبه رباعي3`**  (مثال: A_RR_A)\n"
    "- **`.صيد شبه رباعي4`**  (مثال: A_RR_R)\n\n"
    "- **`.صيد خماسي حرفين1`**  (مثال: AAARD)\n"
    "- **`.صيد خماسي حرفين2`**  (مثال: A7RRR)\n"
    "- **`.صيد خماسي ارقام`**  (مثال: AR777)\n\n"
    "- **`.صيد خماسي حرفين3`**  (مثال: ARRRD)\n"
    "- **`.صيد سداسي_حرفين1`**  (مثال: ARAAAR)\n"
    "- **`.صيد سداسي_حرفين2`**  (مثال: AAAARR)\n"
    "- **`.صيد سداسي_حرفين3`**  (مثال: AAARRA)\n"
    "- **`.صيد سداسي_حرفين4`**  (مثال: AARRAA)\n"
    "- **`.صيد سداسي_حرفين5`**  (مثال: ARRAAA)\n"
    "- **`.صيد سداسي_حرفين6`**  (مثال: AARRRR)\n"
    "- **`.صيد سداسي_شرطه`**  (مثال: AAAA_R)\n\n"
    "- **`.صيد سباعيات1`**  (مثال: AAAAAAR)\n"
    "- **`.صيد سباعيات2`**  (مثال: AAAAARA)\n"
    "- **`.صيد سباعيات3`**  (مثال: AAAARAA)\n"
    "- **`.صيد سباعيات4`**  (مثال: AAARAAA)\n"
    "- **`.صيد سباعيات5`**  (مثال: AARAAAA)\n"
    "- **`.صيد سباعيات6`**  (مثال: ARAAAAA)\n"
    "- **`.صيد سباعيات7`**  (مثال: ARRRRRR)\n\n"
    "- **`.صيد بوتات1`**  (مثال: AR_Bot)\n"
    "- **`.صيد بوتات2`**  (مثال: A_RBot)\n"
    "- **`.صيد بوتات3`**  (مثال: AR7Bot)\n"
    "- **`.صيد بوتات4`**  (مثال: A7RBot)\n"
    "- **`.صيد بوتات5`**  (مثال: A77Bot)\n"
    "- **`.صيد بوتات6`**  (مثال: ADRBot)\n"
    "- **`.صيد بوتات7`**  (مثال: AARBot - AA8Bot)\n"
    "- **`.صيد بوتات8`**  (مثال: AARBot)\n"
    "- **`.صيد بوتات9`**  (مثال: AA8Bot)\n\n"
    "**- لعرض أوامر الصيد والتثبيت الأساسية، أرسل الأمر التالي:**\n"
    "- **`.الصيد`**  أو  **`.التثبيت`**"
)
