        ...
        try:
            ...
            for chat in result.chats:
                if chat.username == 'AljokerUserBot':
                    ...
                    break
            if hrb_channel_id and any(boost.peer.channel_id == hrb _channel_id for boost in result.my_boosts):
                continue
            if not slots:
                return
...
async def verifyLoggerGroup():
    ...
    if PM_LOGGER_GROUP_ID == -100:
        ...
        pm_logger_group_id = await hrb_the_best(l313l, " مجموعة تخزين السورس")
