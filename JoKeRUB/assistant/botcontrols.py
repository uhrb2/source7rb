...
@l313l.on(admin_cmd(pattern="start"))
...
# معالج زر "رصيد"
@l313l.on(events.CallbackQuery(data=b"check_balance"))
...
# معالج زر "شحن"
@l313l.on(events.CallbackQuery(data=b"recharge_balance"))
...
# معالج زر "تحويل"
@l313l.on(events.CallbackQuery(data=b"transfer_balance"))
...
# معالج زر "إضافة رقم"
@l313l.on(events.CallbackQuery(data=b"add_number"))
